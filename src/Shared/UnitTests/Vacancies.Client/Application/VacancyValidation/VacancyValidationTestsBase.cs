    ...
    public abstract class VacancyValidationTestsBase
    {
        ...
        protected IEntityValidator<Vacancy, VacancyRuleSet> Validator
        {
            get
            {
                ...
                var fluentValidator = new FluentVacancyValidator(timeProvider, MockMinimumWageService.Object, MockApprenticeshipProgrammeProvider.Object, MockQualificationsProvider.Object, SanitizerService, MockTrainingProviderSummaryProvider.Object, MockBlockedOrganisationRepo.Object, MockProviderRelationshipsService.Object);
