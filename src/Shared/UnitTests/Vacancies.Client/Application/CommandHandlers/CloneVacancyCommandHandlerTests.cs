...
public class CloneVacancyCommandHandlerTests
{
    ...
    private static void AssertKnownProperties(Vacancy original, Vacancy clone)
    {
        var propertyAssertions = new Dictionary<string, Action<Vacancy, Vacancy, string>>
        {
            ...
            {nameof(Vacancy.EmployerLocation), (o, c, s) => AssertProperty(o, c, s, CloneAssertType.Ignore)},
            {nameof(Vacancy.EmployerLocations), (o, c, s) => AssertProperty(o, c, s, CloneAssertType.Ignore)},
            {nameof(Vacancy.EmployerLocationOption), (o, c, s) => AssertProperty(o, c, s, CloneAssertType.Ignore)},
            {nameof(Vacancy.EmployerLocationInformation), (o, c, s) => AssertProperty(o, c, s, CloneAssertType.Ignore)},
