...
namespace Esfa.Recruit.Vacancies.Client.UnitTests.Shared.Web.Helpers
{
    public class VacancyFilterHeadingHelperTests
    {
        ...
        [InlineData(0, FilteringOptions.Submitted, "", "0 adverts pending esfa review")]
        ...
        [InlineData(1, FilteringOptions.Submitted, "", "1 advert pending esfa review")]
        ...
        [InlineData(6, FilteringOptions.Submitted, "", "6 adverts pending esfa review")]
        ...
        [InlineData(0, FilteringOptions.Submitted, "search", "0 adverts pending esfa review with 'search'")]
        ...
        [InlineData(1, FilteringOptions.Submitted, "search", "1 advert pending esfa review with 'search'")]
        ...
        [InlineData(6, FilteringOptions.Submitted, "search", "6 adverts pending esfa review with 'search'")]
