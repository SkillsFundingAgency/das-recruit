...
public class WhenGettingSectionThreeState
{
    ...
    public static readonly IEnumerable<object[]> SectionThreeFieldsTestCases =
        new List<object[]>
        {
            ...
            new object[] { ApprenticeshipTypes.Standard, (ProviderTaskListStateView v) => v.OtherOtherRequirementsEditable, TaskListItemFlags.FutureProspects },
            ...
            new object[] { ApprenticeshipTypes.Foundation, (ProviderTaskListStateView v) => v.OtherOtherRequirementsEditable, TaskListItemFlags.FutureProspects },
        };
