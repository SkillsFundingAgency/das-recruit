...
namespace Esfa.Recruit.Vacancies.Client.Infrastructure.Extensions
{
    ...
    {
        public static LiveVacancy ToLiveVacancyProjection(this Vacancy vacancy, ApprenticeshipProgramme programme) => new LiveVacancy
        {
            Id = QueryViewType.LiveVacancy.GetIdValue(vacancy.VacancyReference.ToString()),
