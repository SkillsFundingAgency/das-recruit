...
public class VacancyReviewService(IOuterApiClient outerApiClient, IEncodingService encodingService) : IVacancyReviewRepository, IVacancyReviewQuery
{
    ...
    {
        await outerApiClient.Post(new PostVacancyReviewRequest(vacancy.Id,(VacancyReviewDto)vacancy));
    }
    ...
    {
        await outerApiClient.Post(new PostVacancyReviewRequest(review.Id,(VacancyReviewDto)review));
    }
