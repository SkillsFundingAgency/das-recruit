    ...
    public sealed class FluentVacancyValidator : AbstractValidator<Vacancy>
    {
        ...
        private void ValidateTrainingDescription()
        {
            RuleFor(x => x.TrainingDescription)
                ...
                .MaximumLength(4000)
                    .WithMessage("Training and qualifications the apprentice will get must not exceed {MaxLength} characters")
                    .WithErrorCode("7")
                .WithState(_ => VacancyRuleSet.TrainingDescription)
                .ValidHtmlCharacters(_htmlSanitizerService)
                    .WithMessage( "Training and qualifications the apprentice will get contains some invalid characters")
                    .WithErrorCode("6")
                .WithState(_ => VacancyRuleSet.TrainingDescription)
                .ProfanityCheck(_profanityListProvider)
                .WithMessage("Training and qualifications the apprentice will get must not contain a banned word or phrase")
                .WithErrorCode("610")
                .WithState(_ => VacancyRuleSet.TrainingDescription)
