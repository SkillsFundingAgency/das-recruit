    ...
    public class VacancyComparerService : IVacancyComparerService
    {
        public VacancyComparerResult Compare(Vacancy a, Vacancy b)
        {
            var fields = new List<VacancyComparerField>
            {
                ...
                CompareValue(a, b, v => v.EmployerContactEmail, FieldIdResolver.ToFieldId(v => v.EmployerContactEmail)),
                CompareValue(a, b, v => v.EmployerContactName, FieldIdResolver.ToFieldId(v => v.EmployerContactName)),
                CompareValue(a, b, v => v.EmployerContactPhone, FieldIdResolver.ToFieldId(v => v.EmployerContactPhone)),
