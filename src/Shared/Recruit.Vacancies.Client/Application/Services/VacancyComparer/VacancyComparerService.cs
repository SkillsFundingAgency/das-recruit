    ...
    public class VacancyComparerService : IVacancyComparerService
    {
        public VacancyComparerResult Compare(Vacancy a, Vacancy b)
        {
            var fields = new List<VacancyComparerField>
            {
                ...
                CompareValue(a, b, v => v.EmployerContact?.ContactEmail, FieldIdResolver.ToFieldId(v => v.EmployerContact.ContactEmail)),
                CompareValue(a, b, v => v.EmployerContact?.ContactName, FieldIdResolver.ToFieldId(v => v.EmployerContact.ContactName)),
                CompareValue(a, b, v => v.EmployerContact?.ContactPhone, FieldIdResolver.ToFieldId(v => v.EmployerContact.ContactPhone)),
