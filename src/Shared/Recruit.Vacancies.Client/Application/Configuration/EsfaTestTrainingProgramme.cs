...
public static class EsfaTestTrainingProgramme
{
    ...
    public const ApprenticeshipLevel ApprenticeshipLevel = Domain.Entities.ApprenticeshipLevel.Unknown;
    public const TrainingType ApprenticeshipType = TrainingType.Standard;
}