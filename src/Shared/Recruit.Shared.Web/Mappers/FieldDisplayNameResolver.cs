...
namespace Esfa.Recruit.Shared.Web.Mappers
{
    public static class FieldDisplayNameResolver
    {
        private static readonly Dictionary<string, string> FieldNames = new Dictionary<string, string>
        {
            ...
            { FieldIdResolver.ToFieldId(v => v.EmployerContact.ContactEmail), "Employer contact email" },
            { FieldIdResolver.ToFieldId(v => v.EmployerContact.ContactName), "Employer contact name" },
            { FieldIdResolver.ToFieldId(v => v.EmployerContact.ContactPhone), "Employer contact phone" },
