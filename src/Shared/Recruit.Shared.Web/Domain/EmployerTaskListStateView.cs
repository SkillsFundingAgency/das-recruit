...
public sealed class EmployerTaskListStateView
{
    public Dictionary<TaskListItemFlags, bool> CompleteStates { get; }
    ...
    public EmployerTaskListStateView(Dictionary<TaskListItemFlags, bool> completeStates, Vacancy vacancy)
    {
        ...
        // Section Five
        AdditionalQuestionsEditable = CompleteStates[TaskListItemFlags.AdditionalQuestions] || SectionFourState == VacancyTaskListSectionState.Completed;
        
        // Section Six
        CheckYourAnswersEditable = SectionSixState != VacancyTaskListSectionState.NotStarted;
    }

    private bool AllFlagsCompleted(TaskListItemFlags sectionFlags)
    {
    ...
    private bool AnyFlagsCompleted(TaskListItemFlags flags)
    {
        return Enum.GetValues<TaskListItemFlags>()
