...
namespace Esfa.Recruit.Shared.Web.RuleTemplates
{
    public static class VacancyTitlePopularityRuleMessageTemplate
    {
        ...
        {
            return $"The {fieldName.ToLower()} '{msgData.VacancyTitle}' is not common for apprenticeships with the training {msgData.TrainingType} {msgData.TrainingCode} - {msgData.TrainingTitle}.";
        }
    }
}
