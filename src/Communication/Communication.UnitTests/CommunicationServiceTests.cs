...
namespace Communication.UnitTests
{
    public class CommunicationServiceTests
    {
        ...
        private CommunicationRequest _arbitraryCommRequest = new (CommunicationConstants.RequestType.VacancyWithdrawnByQa, string.Empty, string.Empty);
        ...
        public CommunicationServiceTests()
        {
            ...
            _sut = new CommunicationService(Mock.Of<ILogger<CommunicationService>>(), _mockProcessor.Object,
                                            _mockRepository.Object, _mockDispatchQueuePublisher.Object);
        }
