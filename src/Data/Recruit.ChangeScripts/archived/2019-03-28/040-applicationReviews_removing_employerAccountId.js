{
    print("Start removing employerAccountId from applicationReviews.");

    const query = {
            "employerAccountId": { $exists: true }
        },
        batchUpdateLimit = 500,
        coll = db.applicationReviews;
    let passThrough = 1,
    ...
    print("Finished removing employerAccountId from applicationReviews.");
}