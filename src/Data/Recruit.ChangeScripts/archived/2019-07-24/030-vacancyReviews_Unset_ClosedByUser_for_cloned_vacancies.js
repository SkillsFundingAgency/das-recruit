{
    ...
    print("Start updating VacancyReviews unsetting closedByUser for cloned vacancies.");

    var coll = db.vacancyReviews;

    const query = { 
            "vacancySnapshot.sourceVacancyReference": { $exists : true},
            "vacancySnapshot.closedByUser": { $exists : true},
        },
    ...
    do {
        ...
        while (matchedDocs.hasNext()) {
            ...
            var updateDocument = {
                $unset: {
                    "vacancySnapshot.closedByUser": true
                }};
    ...
    print("Finished updating VacancyReviews unsetting closedByUser for cloned vacancies.");
}