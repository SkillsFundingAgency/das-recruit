    ...
    public class EmployerContactDetailsOrchestratorTests
    {
        ...
        public class EmployerContactDetailsOrchestratorTestsFixture
        {
            ...
            public void Setup()
            {
                ...
                Sut = new EmployerContactDetailsOrchestrator(MockClient.Object, MockRecruitVacancyClient.Object, Mock.Of<ILogger<EmployerContactDetailsOrchestrator>>(), Mock.Of<IReviewSummaryService>());
            }
