    ...
    public class ApplicationProcessOrchestratorTests
    {
        ...
        public class ApplicationProcessOrchestratorTestsFixture
        {
            ...
            public void Setup()
            {
                ...
                Sut = new ApplicationProcessOrchestrator(MockClient.Object, MockRecruitVacancyClient.Object, Options.Create(new ExternalLinksConfiguration()), Mock.Of<ILogger<ApplicationProcessOrchestrator>>(), Mock.Of<IReviewSummaryService>());
            }
