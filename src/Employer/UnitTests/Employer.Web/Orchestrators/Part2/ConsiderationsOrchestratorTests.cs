...
namespace Esfa.Recruit.Employer.UnitTests.Employer.Web.Orchestrators.Part2
{
    public class ConsiderationsOrchestratorTests
    {
        ...
        [Fact]
        public async Task WhenThingsToConsiderIsUpdated__ShouldCallUpdateDraftVacancy()
        {
            _fixture
        ...
        [Fact]
        public async Task WhenThingsToConsiderIsUpdated_ShouldFlagEmployerDescriptionFieldIndicator()
        {
            _fixture
                .WithThingsToConsider("has a value")
                .Setup();
