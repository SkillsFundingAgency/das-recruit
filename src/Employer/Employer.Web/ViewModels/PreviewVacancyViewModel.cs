...
namespace Esfa.Recruit.Employer.Web.ViewModels
{
    public class PreviewVacancyViewModel
    {
        ...
        public string ClosingDateCaption => ClosingDate.ToShortDateString();
        ...
        public decimal HoursPerWeek { get; internal set; }
        public string HoursPerWeekCaption => HoursPerWeek.ToString().Replace(".00", string.Empty);
