    ...
    public class WageExtraInformationViewModel : WageViewModel
    {
        public string RouteName
        {
            get
            {
                ...
                return routeMappings.TryGetValue(WageType ?? Recruit.Vacancies.Client.Domain.Entities.WageType.NationalMinimumWage, out var routeName) ? routeName : RouteNames.EmployerCheckYourAnswersGet;
            }
        }
