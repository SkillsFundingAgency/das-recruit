...
namespace Esfa.Recruit.Employer.Web.Controllers
{
    ...
    public class VacancyPreviewController : Controller
    {
        ...
        private void SetSectionStates(VacancyPreviewViewModel viewModel)
        {
            ...
            viewModel.ContactSectionState = GetSectionState(viewModel, new[] { FieldIdentifiers.EmployerContact }, false, vm => vm.ContactName, vm => vm.ContactEmail, vm => vm.ContactTelephone);
