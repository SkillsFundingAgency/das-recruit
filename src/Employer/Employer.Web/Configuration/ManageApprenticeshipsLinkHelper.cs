...
namespace Esfa.Recruit.Employer.Web.Configuration
{
    public class ManageApprenticeshipsLinkHelper
    {
        ...
        public string CookieConsent => $"{_externalLinks.ManageApprenticeshipSiteUrl}{_maRoutes.ManageApprenticeshipSiteCookieConsentRoute}";
        public string CookieConsentWithHashedAccount => $"{_externalLinks.ManageApprenticeshipSiteUrl}{_maRoutes.ManageApprenticeshipSiteCookieConsentRouteWithHashedAccountId}";
        ...
        public string YourTrainingProviderPermission => $"{_externalLinks.TrainingProviderPermissionUrl}{_maRoutes.YourTrainingProviderPermissionRoute}";
