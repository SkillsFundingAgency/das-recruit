...
namespace Esfa.Recruit.Provider.Web.ViewModels.Dashboard
{
    public class DashboardViewModel
    {
        ...
        public int NumberOfEmployerReviewedApplications => ProviderDashboardSummary.NumberOfEmployerReviewedApplications;
        public bool ShowAllApplications => ProviderDashboardSummary.HasApplications;
        public string ApplicationTextEmployerReviewedApplication => "Employer reviewed applications".ToQuantity(NumberOfEmployerReviewedApplications, ShowQuantityAs.None);
