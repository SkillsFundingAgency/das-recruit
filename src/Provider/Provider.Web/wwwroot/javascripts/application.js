...
SelectAllCheckboxes.prototype.createSelectAll = function () {
  ...
  var tableCell = this.checkBoxesWrap.querySelector(
...
SelectAllCheckboxes.prototype.toggleCheckboxes = function (e) {
  ...
  var checkboxes = this.checkBoxesWrap.querySelectorAll(
    'input[type="checkbox"]'
  );
...
var CookieBanner = {
  ...
  addCookieMessage: function () {
    ...
    var hasCookieMessage =
      message && CookieBanner.init("seen_cookie_message") === null;
...
var tableSort = function () {
  ...
  var allSortLinks = sortableTable.querySelectorAll(
    ".govuk-table__header .govuk-link"
  );
  ...
  var handleClick = function (e) {
    ...
    Array.from(
      sortableTable.querySelectorAll(".govuk-table__body .govuk-table__row")
    )
      .sort(
        comparer(
          Array.from(sortLink.parentNode.parentNode.children).indexOf(
            sortLink.parentNode
          ),
          directionToSort === "ascending"
        )
      )
      .forEach((tr) =>
        sortableTable.querySelector(".govuk-table__body").appendChild(tr)
      );
  };
