    ...
    public class AboutEmployerOrchestratorTests
    {
        ...
        public class AboutEmployerOrchestratorTestsFixture
        {
            ...
            public void Setup()
            {
                ...
                Sut = new AboutEmployerOrchestrator(MockRecruitVacancyClient.Object, Mock.Of<ILogger<AboutEmployerOrchestrator>>(), Mock.Of<IReviewSummaryService>(), new Utility(MockRecruitVacancyClient.Object));
            }
