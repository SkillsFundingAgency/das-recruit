    ...
    public class ShortDescriptionOrchestratorTests
    {
        ...
        public class ShortDescriptionOrchestratorTestsFixture
        {
            ...
            public void Setup()
            {
                ...
                Sut = new ShortDescriptionOrchestrator(MockRecruitVacancyClient.Object, Mock.Of<ILogger<ShortDescriptionOrchestrator>>(), Mock.Of<IReviewSummaryService>(), new Utility(MockRecruitVacancyClient.Object,Mock.Of<IFeature>()));
            }
