...
public class WageOrchestratorTests
{
    ...
    [TestCase(WageType.FixedWage, "this is a value", true)]
    [TestCase(WageType.NationalMinimumWage, "this is a value", true)]
    [TestCase(WageType.NationalMinimumWageForApprentices, "this is a value", true)]
    [TestCase(WageType.CompetitiveSalary, "this is a new value", true)]
    ...
    public class WageOrchestratorTestsFixture
    {
        ...
        public void Setup()
        {
            ...
            Sut = new WageOrchestrator(MockRecruitVacancyClient.Object, Mock.Of<ILogger<WageOrchestrator>>(),
                Mock.Of<IReviewSummaryService>(), Mock.Of<IMinimumWageProvider>(), new Utility(MockRecruitVacancyClient.Object, Mock.Of<ITaskListValidator>()));
        }
