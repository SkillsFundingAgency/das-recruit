...
namespace Esfa.Recruit.Vacancies.Jobs.VacancyApplication
{
    public class VacancyApplicationCommandHandler
    {
        ...
        public VacancyApplicationCommandHandler(IVacancyRepository vacancyRepository, IApplicationReviewRepository applicationReviewRepository, ILogger<VacancyApplicationCommandHandler> logger, ITimeProvider timeProvider, IMessaging messaging)
        {
            _logger = logger;
