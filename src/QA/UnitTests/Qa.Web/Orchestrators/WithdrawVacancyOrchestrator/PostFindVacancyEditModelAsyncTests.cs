...
namespace UnitTests.Qa.Web.Orchestrators.WithdrawVacancyOrchestrator
{
    public class PostFindVacancyEditModelAsyncTests
    {
        ...
        public async Task ShouldReturnCannotCloseIfVacancyExistsAndIsNotLive(VacancyStatus status)
        {
            ...
            result.ResultType.Should().Be(PostFindVacancyEditModelResultType.CannotClose);
        }
