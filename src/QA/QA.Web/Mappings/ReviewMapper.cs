...
namespace Esfa.Recruit.Qa.Web.Mappings
{
    public class ReviewMapper
    {
        ...
        private static readonly Dictionary<string, IEnumerable<string>> ReviewFields = new Dictionary<string, IEnumerable<string>>
        {
            ...
            { FieldIdResolver.ToFieldId(v => v.EmployerContact.Name), new []{ VacancyReview.FieldIdentifiers.EmployerContact }},
            { FieldIdResolver.ToFieldId(v => v.EmployerContact.Email), new []{VacancyReview.FieldIdentifiers.EmployerContact} },
            { FieldIdResolver.ToFieldId(v => v.EmployerContact.Phone), new []{VacancyReview.FieldIdentifiers.EmployerContact }},
